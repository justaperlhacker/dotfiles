...
"hi Comment guifg=#C0C0C0 gui=italic ctermfg=240
...
hi Pmenu guifg=#000000 guibg=#9CBBDE
...
hi ColorColumn guifg=NONE guibg=#303030 gui=NONE ctermfg=NONE ctermbg=233
