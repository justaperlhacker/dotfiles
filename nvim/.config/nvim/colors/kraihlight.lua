...
hi('rakuPackage', { link = 'Type' })
hi('rakuPackageScope', { fg = '#d6b67f' })
hi('rakuTwigil', { fg = '#d08356' })
hi('rakuBareSigil', { fg = '#d08356' })
hi('rakuVariable', { fg = '#899ab4' })
hi('rakuVarName', { fg = '#899ab4' })
hi('rakuVarStorage', { fg = '#899ab4' })
hi('rakuVarExclam', { fg = '#d6b67f' })
hi('rakuIdentifier', { fg = '#899ab4' })
hi('rakuType', { link = 'Type' })
hi('rakuTypeConstraint', { fg = '#d87d5f' })
hi('rakuDeclare', { fg = '#d6b67f' })
hi('rakuDeclareRegex', { fg = '#d6b67f' })
hi('rakuConditional', { link = 'Conditional' })
hi('rakuException', { link = 'Exception' })
hi('rakuFlowControl', { fg = '#d6b67f' })
hi('rakuClosureTrait', { fg = '#899ab4' })
hi('rakuContext', { link = 'Operator' })
hi('rakuHyperOp', { link = 'Operator' })
hi('rakuOperator', { link = 'Operator' })
hi('rakuSetOp', { link = 'Operator' })
hi('rakuBlockLabel', { fg = '#d6b67f' })
hi('rakuNumber', { link = 'Number' })
hi('rakuVersion', { fg = '#d08356' })
hi('rakuInclude', { link = 'Include' })

-- Raku strings / interpolation
hi('rakuString', { link = 'String' })
hi('rakuStringDQ', { link = 'String' })
hi('rakuStringSQ', { link = 'String' })
hi('rakuStringQ', { link = 'String' })
hi('rakuStringAngle', { link = 'String' })
hi('rakuStringSpecial', { fg = '#ac98ac' })
hi('rakuStringSpecial2', { fg = '#ac98ac' })
hi('rakuKey', { link = 'String' })
hi('rakuShebang', { fg = '#8a9597', italic = true })

-- Raku regex / match operators
hi('rakuMatch', { fg = '#ac98ac' })
hi('rakuMatchBare', { fg = '#ac98ac' })
hi('rakuMatchVar', { fg = '#899ab4' })
hi('rakuSubstitution', { fg = '#ac98ac' })
hi('rakuTransliteration', { fg = '#ac98ac' })
hi('rakuRxMeta', { fg = '#d08770' })
hi('rakuRxAnchor', { fg = '#d08770' })
hi('rakuRxCharClass', { fg = '#ac98ac' })
hi('rakuRxAssertGroup', { fg = '#ac98ac' })

-- Raku POD / documentation
hi('rakuPod', { fg = '#726d73', italic = true })
hi('rakuPodFormat', { link = 'Special' })
hi('rakuPodCode', { fg = '#9fac7f' })
hi('rakuPodComment', { fg = '#726d73', italic = true })
hi('rakuPodDelim', { fg = '#d6b67f' })

-- Raku attention / error
hi('rakuAttention', { link = 'Todo' })
hi('rakuError', { link = 'Error' })
...
-- Navic (breadcrumbs)
hi('NavicText', { fg = '#e6e6e6' })
hi('NavicSeparator', { fg = '#8a9597' })
hi('NavicIconsFile', { fg = '#8a9597' })
hi('NavicIconsModule', { fg = '#899ab4' })
hi('NavicIconsNamespace', { fg = '#899ab4' })
hi('NavicIconsPackage', { fg = '#899ab4' })
hi('NavicIconsClass', { fg = '#d87d5f' })
hi('NavicIconsMethod', { fg = '#ab8252' })
hi('NavicIconsProperty', { fg = '#899ab4' })
hi('NavicIconsField', { fg = '#899ab4' })
hi('NavicIconsConstructor', { fg = '#ab8252' })
hi('NavicIconsEnum', { fg = '#ac98ac' })
hi('NavicIconsInterface', { fg = '#d87d5f' })
hi('NavicIconsFunction', { fg = '#ab8252' })
hi('NavicIconsVariable', { fg = '#899ab4' })
hi('NavicIconsConstant', { fg = '#d08356' })
hi('NavicIconsString', { fg = '#9fac7f' })
hi('NavicIconsNumber', { fg = '#9fac7f' })
hi('NavicIconsBoolean', { fg = '#9fac7f' })
hi('NavicIconsArray', { fg = '#ac98ac' })
hi('NavicIconsObject', { fg = '#899ab4' })
hi('NavicIconsKey', { fg = '#d6b67f' })
hi('NavicIconsNull', { fg = '#8a9597' })
hi('NavicIconsEnumMember', { fg = '#ac98ac' })
hi('NavicIconsStruct', { fg = '#d87d5f' })
hi('NavicIconsEvent', { fg = '#d6b67f' })
hi('NavicIconsOperator', { fg = '#f9f9f9' })
hi('NavicIconsTypeParameter', { fg = '#d87d5f' })
